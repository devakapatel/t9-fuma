...
```java title="CloudSimExample3.java"
/*
...
```
terminated> CloudSimExample3 [Java Application] C:\Program Files\Java\jdk1.8.0_281\bin\javaw.exe (Jun 10,
Starting CloudSimExample3...
...
3.1: Broker: Sending cloudlet 0 to VM #0
3.1: Broker: Sending cloudlet 1 to VM #1
30.1: Broker: Cloudlet 1 received
...
OUTPUT
Cloudlet ID  STATUS  Data center ID  VM ID  Time  Start Time  Finish T
